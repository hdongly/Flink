//package com.apple.state.common;
//
...
//import com.geekbang.flink.state.common.artificialstate.ArtificalOperatorStateMapper;
//import com.geekbang.flink.state.common.artificialstate.ArtificialKeyedStateMapper;
//import com.geekbang.flink.state.common.artificialstate.builder.ArtificialListStateBuilder;
//import com.geekbang.flink.state.common.artificialstate.builder.ArtificialStateBuilder;
//import com.geekbang.flink.state.common.artificialstate.builder.ArtificialValueStateBuilder;
//
...
//	public static final ConfigOption<String> TEST_SEMANTICS = ConfigOptions
//		.key("test.semantics")
//		.defaultValue("exactly-once")
//		.withDescription("This configures the semantics to test. Can be 'exactly-once' or 'at-least-once'");
//
//	public static final ConfigOption<Boolean> TEST_SIMULATE_FAILURE = ConfigOptions
...
//
//	public static final ConfigOption<Long> TEST_SIMULATE_FAILURE_NUM_RECORDS = ConfigOptions
...
//
//	public static final ConfigOption<Long> TEST_SIMULATE_FAILURE_NUM_CHECKPOINTS = ConfigOptions
...
//				" Only relevant if configured to simulate failures.");
//
//	public static final ConfigOption<Integer> TEST_SIMULATE_FAILURE_MAX_FAILURES = ConfigOptions
...
//				" Only relevant if configured to simulate failures.");
//
//	public static final ConfigOption<Long> ENVIRONMENT_CHECKPOINT_INTERVAL = ConfigOptions
//		.key("environment.checkpoint_interval")
//		.defaultValue(1000L);
//
//	public static final ConfigOption<Boolean> ENVIRONMENT_EXTERNALIZE_CHECKPOINT = ConfigOptions
//		.key("environment.externalize_checkpoint")
//		.defaultValue(false);
//
//	public static final ConfigOption<String> ENVIRONMENT_EXTERNALIZE_CHECKPOINT_CLEANUP = ConfigOptions
//		.key("environment.externalize_checkpoint.cleanup")
//		.defaultValue("retain");
//
//	public static final ConfigOption<Integer> ENVIRONMENT_TOLERABLE_DECLINED_CHECKPOINT_NUMBER = ConfigOptions
//		.key("environment.tolerable_declined_checkpoint_number ")
//		.defaultValue(0);
//
//	public static final ConfigOption<Integer> ENVIRONMENT_PARALLELISM = ConfigOptions
//		.key("environment.parallelism")
//		.defaultValue(1);
//
//	public static final ConfigOption<Integer> ENVIRONMENT_MAX_PARALLELISM = ConfigOptions
//		.key("environment.max_parallelism")
//		.defaultValue(128);
//
//	public static final ConfigOption<String> ENVIRONMENT_RESTART_STRATEGY = ConfigOptions
//		.key("environment.restart_strategy")
//		.defaultValue("fixed_delay");
//
//	public static final ConfigOption<Integer> ENVIRONMENT_RESTART_STRATEGY_FIXED_ATTEMPTS = ConfigOptions
//		.key("environment.restart_strategy.fixed_delay.attempts")
//		.defaultValue(Integer.MAX_VALUE);
//
//	public static final ConfigOption<Long> ENVIRONMENT_RESTART_STRATEGY_FIXED_DELAY = ConfigOptions
...
//
//	public static final ConfigOption<String> STATE_BACKEND_CHECKPOINT_DIR = ConfigOptions
//		.key("state_backend.checkpoint_directory")
//		.noDefaultValue()
//		.withDescription("The checkpoint directory.");
//
//	public static final ConfigOption<Boolean> STATE_BACKEND_ROCKS_INCREMENTAL = ConfigOptions
...
//
//	public static final ConfigOption<Boolean> STATE_BACKEND_FILE_ASYNC = ConfigOptions
...
//
//	public static final ConfigOption<Integer> SEQUENCE_GENERATOR_SRC_KEYSPACE = ConfigOptions
//		.key("sequence_generator_source.keyspace")
//		.defaultValue(200);
//
//	public static final ConfigOption<Integer> SEQUENCE_GENERATOR_SRC_PAYLOAD_SIZE = ConfigOptions
//		.key("sequence_generator_source.payload_size")
//		.defaultValue(20);
//
//	public static final ConfigOption<Long> SEQUENCE_GENERATOR_SRC_SLEEP_TIME = ConfigOptions
//		.key("sequence_generator_source.sleep_time")
//		.defaultValue(0L);
//
//	public static final ConfigOption<Long> SEQUENCE_GENERATOR_SRC_SLEEP_AFTER_ELEMENTS = ConfigOptions
//		.key("sequence_generator_source.sleep_after_elements")
//		.defaultValue(0L);
//
//	public static final ConfigOption<Long> SEQUENCE_GENERATOR_SRC_EVENT_TIME_MAX_OUT_OF_ORDERNESS = ConfigOptions
//		.key("sequence_generator_source.event_time.max_out_of_order")
//		.defaultValue(0L);
//
//	public static final ConfigOption<Long> SEQUENCE_GENERATOR_SRC_EVENT_TIME_CLOCK_PROGRESS = ConfigOptions
//		.key("sequence_generator_source.event_time.clock_progress")
//		.defaultValue(100L);
//
//	public static final ConfigOption<Long> TUMBLING_WINDOW_OPERATOR_NUM_EVENTS = ConfigOptions
//		.key("tumbling_window_operator.num_events")
//		.defaultValue(20L);
//
//	public static final ConfigOption<Integer> TEST_SLIDE_FACTOR = ConfigOptions
//		.key("test_slide_factor")
//		.defaultValue(3);
//
//	public static final ConfigOption<Long> TEST_SLIDE_SIZE = ConfigOptions
//		.key("test_slide_size")
//		.defaultValue(250L);
//
...
//	}
//
//	public static void setupCheckpointing(final StreamExecutionEnvironment env, final ParameterTool pt) {
...
//	}
//
//	public static void setupParallelism(final StreamExecutionEnvironment env, final ParameterTool pt) {
...
//	}
//
//	public static void setupRestartStrategy(final StreamExecutionEnvironment env, final ParameterTool pt) {
...
//	}
//
//	public static void setupStateBackend(final StreamExecutionEnvironment env, final ParameterTool pt) throws IOException {
...
//	}
//
//	public static BoundedOutOfOrdernessTimestampExtractor<Event> createTimestampExtractor(ParameterTool pt) {
...
//					SEQUENCE_GENERATOR_SRC_EVENT_TIME_MAX_OUT_OF_ORDERNESS.defaultValue()))) {
//
//			public static final long serialVersionUID = -3154419724891779938L;
//
//			@Override
...
//	}
//
//	public static <IN, STATE> ArtificialStateBuilder<IN> createValueStateBuilder(
//		JoinFunction<IN, STATE, STATE> inputAndOldStateToNewState,
...
//	}
//
//	public static <IN, STATE> ArtificialStateBuilder<IN> createListStateBuilder(
//		JoinFunction<IN, STATE, STATE> inputAndOldStateToNewState,
...
//	}
//
//	public static class EventIdentityFunctionWithCustomEventTypeInformation
//		implements MapFunction<Event, Event>, ResultTypeQueryable<Event> {
//
//		public final SingleThreadAccessCheckingTypeInfo<Event> typeInformation = new SingleThreadAccessCheckingTypeInfo<>(Event.class);
//
//		@Override
...
//	}
//
//	public static class EventKeySelectorWithCustomKeyTypeInformation
//		implements KeySelector<Event, Integer>, ResultTypeQueryable<Integer> {
//
//		public final SingleThreadAccessCheckingTypeInfo<Integer> typeInformation = new SingleThreadAccessCheckingTypeInfo<>(Integer.class);
//
//		@Override
