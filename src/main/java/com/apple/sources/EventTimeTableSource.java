...
public class EventTimeTableSource
    ...
    public EventTimeTableSource(String sourceTag, int numKeys, float recordsPerKeyAndSecond, int durationSeconds, int offsetSeconds) {
